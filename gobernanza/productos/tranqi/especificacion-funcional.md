...
Ver especificación de [Plataforma](../plataforma/especificacion-funcional.md) — PLT-001 (identidad única), PLT-002 (MFA), PLT-003 (membresías). Sin adiciones de Tranqi al mecanismo en sí.
