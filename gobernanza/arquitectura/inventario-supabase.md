...
Tipos TypeScript regenerados en cada migración que cambia columnas — ver `packages/db/src/tipos-generados.ts` (`20260727000009` solo reescribe el cuerpo de una función, no requiere regeneración; lo mismo aplica a `20260728000003/4/5`, que solo tocan funciones/políticas/storage).
