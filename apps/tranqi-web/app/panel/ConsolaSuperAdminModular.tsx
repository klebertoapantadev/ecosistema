...
export const CATALOGO_SUPERADMIN_TODOS: ModuloSuperAdminDef[] = [
  { clave: "gestion_usuarios", nombre: "Gestión de Usuarios & Membresías", detalle: "Asignación de perfiles, roles y techo jerárquico", ruta: "/panel/administrar?widget=gestion_usuarios", icono: Users, iconoKey: "Users", color: "var(--violeta, #5000BA)", rutaFisica: "packages/gestion-usuarios/src/componentes/AdministracionPerfilesWidget.tsx" },
