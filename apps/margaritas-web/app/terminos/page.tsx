...
export const metadata: Metadata = { title: "Términos de Servicio — Margaritas Floristería" };
  ...
  return (
    <div className="pagina-legal">
      ...
      <div className="seccion-legal">
        <h2>1. Qué es Margaritas Floristería</h2>
        <p>
          Margaritas Floristería ofrece productos y servicios de entrega de flores. Al crear una cuenta, aceptas
