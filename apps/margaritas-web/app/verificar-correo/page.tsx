...
export const metadata: Metadata = { title: "Verificar correo — Margaritas Floristería" };
...
export default async function PaginaVerificarCorreo() {
  ...
  return (
    <div className="pagina-mfa">
      ...
      <VerificacionCorreo correo={perfil.usu_correo} negocio="margaritas" nombres={perfil.usu_nombres} />
    </div>
  );
}
