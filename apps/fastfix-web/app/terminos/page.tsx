...
export const metadata: Metadata = { title: "Términos de Servicio — FastFix Home" };
  ...
  return (
    <div className="pagina-legal">
      ...
      <div className="seccion-legal">
        <h2>1. Qué es FastFix Home</h2>
        <p>
          FastFix Home es una plataforma que conecta personas con técnicos independientes para servicios de
          mantenimiento del hogar. Al crear una cuenta, aceptas estos Términos y nuestra Política de Privacidad.
        </p>
      </div>
